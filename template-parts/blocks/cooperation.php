<section class="gives">
    <div class="gives__container2">
        <h2 class="title gives__title">
            <?php echo get_sub_field( 'title' ); ?>
        </h2>
        <?php if ( have_rows( 'lists' ) ) { ?>
            <div class="gives__slider swiper">
                <div class="swiper-wrapper">
                    <?php while ( have_rows( 'lists' ) ) { the_row(); ?>
                        <div class="swiper-slide">
                            <div class="gives-card">
                                <?php if ( get_sub_field( 'icon' ) ) { ?>
                                    <div class="gives-card__icon">
                                        <img src="<?php the_sub_field( 'icon' ); ?>" />
                                    </div>
                                <?php } ?>
                                <div class="gives-card__text">
                ...
                <div class="gives__navigation navigation">
                    <div class="navigation__arrows">
                        <button class="navigation__arrow gives__prev">
                        ...
                        <button class="navigation__arrow gives__next">
                            <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="navigation__pagination gives__pagination">
                    </div>
                </div>
            </div>
		<?php } ?>
