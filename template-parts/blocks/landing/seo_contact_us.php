<section id="contact-us" class="s-converse <?php if ( get_sub_field( 'full_blue_style' ) == 1 ) echo 's-converse--light'; ?>">
    <div class="s-converse__container3">
        <div class="s-converse__wrap">
            <div class="s-converse__content">
                <h2 class="title">
                    <?php echo get_sub_field( 'title' ); ?>
                </h2>
                <div class="s-converse__description">
			...
			<?php if ( $link ) { ?>
                <a href="<?php echo esc_url( $link['url'] ); ?>" target="<?php echo esc_attr( $link['target'] ); ?>" class=" s-converse__link button s-button <?php if ( get_sub_field( 'full_blue_style' ) == 1 ) echo 's-button--light'; ?>">
                    ...
                    <?php } else { ?>
                        <svg><use xlink:href="<?php echo get_template_directory_uri(); ?>/img/icons/icons.svg#telegram"></use></svg>
                    <?php } ?>
