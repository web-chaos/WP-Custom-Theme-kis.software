<section class="works section">
    <div class="works__container2">
        <h2 class="works__title title"><?php echo get_sub_field( 'title' ); ?></h2>
			...
			<?php if ( $projects ) { ?>
                <div class="works__slider swiper">
                    ...
                    <div class="works__row">
                        ...
                        <?php $more_projects = get_sub_field( 'more_projects' ); ?>
                        <?php $term = get_term_by( 'id', $more_projects, 'projects' ); ?>
                        <?php if ( $term ) { ?>
                            <a class="works__link" href="<?php echo esc_url( get_term_link( $term ) ); ?>">
